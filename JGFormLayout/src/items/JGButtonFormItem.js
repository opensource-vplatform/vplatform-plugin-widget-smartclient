define("./JGButtonFormItem", function (require, exports, module) {
	var widgetContext;
    exports.initModule = function(sandbox){
    	require('./IV3FormItem').initModule();
    	widgetContext = sandbox.getService("vjs.framework.extension.platform.services.view.widget.common.context.WidgetContext");
//        isc.ClassFactory.defineClass("JGButtonFormItem", "ButtonItem");
...
//	            };
	            //按钮提示数值样式
                widgetContext.put(this.Code,'widgetObj',this);
